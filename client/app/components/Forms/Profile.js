...
class Profile extends Component {
    ...
    updateRecord() {
        ...
        if(!healthHistory || !prescription || !doctorNotes){
            this.setState({
                errormessage: "Field Are Empty! Please fill the required data!"
            })
        }
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button class="btn pull-right" data-dismiss="modal">Go Back</button>
                                                                    <button class="btn pull-right" onClick={this.updateRecord} >Looks Good!Submit</button>                                                                    
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
